...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.test_predictions_matrix.setGeometry(QtCore.QRect(10, 550, 1861, 421))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(20, 20, 121, 23))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.tab_5)
        self.pushButton_4.setGeometry(QtCore.QRect(150, 20, 121, 23))
        self.pushButton_4.setObjectName("pushButton_4")
        self.comboBox = QtWidgets.QComboBox(self.tab_5)
        self.comboBox.setGeometry(QtCore.QRect(20, 70, 251, 22))
        self.comboBox.setObjectName("comboBox")
        self.label_21 = QtWidgets.QLabel(self.tab_5)
        self.label_21.setGeometry(QtCore.QRect(20, 50, 47, 13))
        self.label_21.setObjectName("label_21")
        self.label_22 = QtWidgets.QLabel(self.tab_5)
        self.label_22.setGeometry(QtCore.QRect(20, 100, 47, 13))
        self.label_22.setObjectName("label_22")
        self.comboBox_2 = QtWidgets.QComboBox(self.tab_5)
        self.comboBox_2.setGeometry(QtCore.QRect(20, 120, 251, 22))
        self.comboBox_2.setObjectName("comboBox_2")
        self.tableWidget_2 = QtWidgets.QTableWidget(self.tab_5)
        self.tableWidget_2.setGeometry(QtCore.QRect(20, 160, 256, 811))
        self.tableWidget_2.setObjectName("tableWidget_2")
        self.tableWidget_2.setColumnCount(0)
        self.tableWidget_2.setRowCount(0)
        self.label_23 = QtWidgets.QLabel(self.tab_5)
        self.label_23.setGeometry(QtCore.QRect(290, 30, 300, 300))
        self.label_23.setAlignment(QtCore.Qt.AlignCenter)
        self.label_23.setObjectName("label_23")
        self.pushButton_5 = QtWidgets.QPushButton(self.tab_5)
        self.pushButton_5.setGeometry(QtCore.QRect(300, 360, 75, 23))
        self.pushButton_5.setObjectName("pushButton_5")
        self.pushButton_6 = QtWidgets.QPushButton(self.tab_5)
        self.pushButton_6.setGeometry(QtCore.QRect(410, 360, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.setText(_translate("MainWindow", "Импорт из CSV"))
        self.pushButton_4.setText(_translate("MainWindow", "Экспорт в CSV"))
        self.label_21.setText(_translate("MainWindow", "Класс"))
        self.label_22.setText(_translate("MainWindow", "Клетка"))
        self.label_23.setText(_translate("MainWindow", "Изображение"))
