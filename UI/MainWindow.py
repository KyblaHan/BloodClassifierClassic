...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(10, 130, 1731, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_12.setText(_translate("MainWindow", "Открыть в проводнике"))
        self.pushButton_11.setText(_translate("MainWindow", "Выбрать файл"))
        ...
        self.pushButton_14.setText(_translate("MainWindow", "Загрузить данные в Систему"))
        self.pushButton_13.setText(_translate("MainWindow", "Тест"))
        ...
        self.pushButton_4.setText(_translate("MainWindow", "Выбрать путь"))
        self.label_14.setText(_translate("MainWindow", "Путь к тестовому датасету:"))
        self.pushButton.setText(_translate("MainWindow", "Выбрать путь"))
        self.lineEdit_2.setText(_translate("MainWindow", "C:\\_Programming\\_DataSets\\Multiclass\\png_devided_data"))
        self.lineEdit.setText(_translate("MainWindow", "C:\\_Programming\\_DataSets\\Multiclass\\png_devided_data"))
        self.pushButton_3.setText(_translate("MainWindow", "Открыть в проводнике"))
        self.pushButton_5.setText(_translate("MainWindow", "Открыть в проводнике"))
        ...
        self.pushButton_10.setText(_translate("MainWindow", "Открыть в проводнике"))
        self.checkBox.setText(_translate("MainWindow", "Использование ГПУ"))
        self.pushButton_7.setText(_translate("MainWindow", "Запустить обучение"))
        self.pushButton_8.setText(_translate("MainWindow", "Протестировать"))
        self.pushButton_9.setText(_translate("MainWindow", "Дообучить модель"))
